execute unless score #forceCap bowGlobal matches -1 if score #arrowForce bowGlobal > #forceCap bowGlobal run scoreboard players operation #arrowForce bowGlobal = #forceCap bowGlobal
