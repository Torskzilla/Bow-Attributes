...
execute store result score #flame bowGlobal run data get storage minecraft:player Player.SelectedItem.components."minecraft:enchantments".levels."minecraft:flame"
