...
execute store result score #flame bowGlobal run data get storage minecraft:player Player.HandItems[0].components."minecraft:enchantments".levels."minecraft:flame"
