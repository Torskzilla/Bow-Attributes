...
execute if score #customCrits bowGlobal matches 1 as @s[tag=crossbowAiming,tag=!critActivated] unless predicate bow:firework_off unless predicate bow:firework_main run function bow:player/crossbow_charge
